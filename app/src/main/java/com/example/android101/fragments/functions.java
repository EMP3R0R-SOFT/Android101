...
public class functions extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout._00_frag_functions, container, false);
...
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(getActivity(), "non-UI function", Toast.LENGTH_LONG).show();
...
//        });
//
//        final Button button14 = getActivity().findViewById(R.id.button14);
//        button14.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(getContext(), _14_Miladi_be_Shamsi.class));
//            }
//        });
//
//        final Button button15 = getActivity().findViewById(R.id.button15);
//        button15.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(getContext(), _15_JobScheduler.class));
//            }
//        });
//
//        final Button button16 = getActivity().findViewById(R.id.button16);
...
//        final Button button17 = getActivity().findViewById(R.id.button17);
//        button17.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(getContext(), _17_JSON_VolleyLibrary.class));
//            }
//        });
//
//        final Button button18 = getActivity().findViewById(R.id.button18);
